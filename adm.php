...
<div class="card-group">
    ...
    <div class="card">
        <a href="./gerenciador/listarProdutos.php">
            <img class="card-img-top" src="./assets/produtos1.jpg" alt="Card image cap">
            <div class="card-body">
                <h5 class="card-title">Listar produtos</h5>
                <p class="card-text">Aqui você será capaz de ver e adicionar produtos conforme seu gosto.</p>
            </div>
    </div>
    </a>
    <div class="card">
        <a href="./gerenciador/listarUsuarios.php">
